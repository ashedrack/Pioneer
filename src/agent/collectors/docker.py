...
class DockerCollector(BaseCollector):
    def __init__(self, agent_config: Dict[str, Any]):
        ...
        self.container_include = agent_config.get('docker', {}).get('include_containers', [])
        self.container_exclude = agent_config.get('docker', {}).get('exclude_containers', [])
    ...
    def collect(self) -> List[Metric]:
        ...
        try:
            ...
            for container in containers:
                ...
                if self.container_include and container.name not in self.container_include:
                    continue
