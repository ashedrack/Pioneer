...
class ResourceOptimizer:
    ...
    def prepare_features(self, df: pd.DataFrame) -> np.ndarray:
        ...
        feature_columns = ['hour', 'day_of_week', 'is_weekend', 'rolling_mean', 
                         'rolling_std', 'lag_1', 'lag_24', 'lag_168']
    ...
    def predict_utilization(self, current_data: pd.DataFrame, 
        ...
        for pred in predictions:
            ...
            if value < threshold_low:
                if current_period is None or current_period['type'] != 'low':
                    ...
                    current_period['avg_value'] = (current_period['avg_value'] + value) / 2
